...
def mainTest():
  ...
  with tf.Graph().as_default(), tf.Session() as session:
    with tf.device("/cpu:0"):
      ...
      print("The vector of word1: ", vec1)

      print("The id of word2: ", model._word2id[word2])
      vec2 = model.nearby_emb.eval(feed_dict={model._nearby_word: model._word2id[word2]})
      print("The vector of word2: ", vec2)
