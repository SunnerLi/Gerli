package com.example.huyuxuan.voiceinput;
...
import edu.sunner.parserdevelop.parser.MoneyHandler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btCheck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast toast = Toast.makeText(MainActivity.this,"expense:"+Integer.toString(tmp.Expense)+" income:"+Integer.toString(tmp.Income),Toast.LENGTH_LONG);
                toast.show();
            }
        });
    }
